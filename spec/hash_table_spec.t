...
local variants = { "linear", "fixed", "dynamic" }
for _, variant in ipairs(variants) do
    describe("Hash variant " .. variant, function()
        describe("hash table 'class' and instance creation", function()
            it("has new and delete operators to get heap instances", function()
                local int_int_map = hash_table{int, int, variant=variant}
        ...
        describe("hash table for null-terminated strings", function()
            local str_str_map = hash_table{rawstring, rawstring, variant=variant}
        ...
        describe("hash table for structs", function()
            ...
            local point_point_map = hash_table{point, point, variant=variant}
            local instance
        ...
        describe("hash table for strings to structs", function()
            ...
            local str_point_map = hash_table{rawstring, point, variant=variant}
        ...
        describe("hash set use cases. create set type with only key type", function()
            -- declaration for set only requires the key-type parameter
            local int_set = hash_table{int, variant=variant}
            local instance
        ...
        describe("typical hash table use cases", function()
