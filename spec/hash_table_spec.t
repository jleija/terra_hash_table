...
for _, flavor in ipairs(flavors) do
    ...
    describe("hash table for structs. Flavor=" .. flavor, function()
        local struct point {
            x : int
            y : int
        }
    ...
    describe("hash table for strings to structs. Flavor=" .. flavor, function()
        local struct point {
            x : int
            y : int
        }
    ...
    describe("memory usage, custom allocator. Flavor=" .. flavor, function()
        local std = terralib.includec("stdlib.h")
