...
void hash_table_insert( hash_table* ht, hash_node* node, void* obj, uint64_t key_hash)
{
	tommy_hashlin_insert(ht, node, obj, key_hash);
}

void* hash_table_search( hash_table* ht, comparison_function compare, void* key, uint64_t key_hash)
{
...
void* hash_table_remove( hash_table* ht, comparison_function compare, void* key, uint64_t key_hash)
{
  return tommy_hashlin_remove(ht, compare, key, key_hash);
}

void hash_table_foreach( hash_table* ht, foreach_function fn)
{
  tommy_hashlin_foreach(ht, fn);
}

void hash_table_foreach_arg( hash_table* ht, foreach_arg_function fn, void* arg)
{
